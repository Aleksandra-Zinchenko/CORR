# Зинченко Александра Валерьевна - для дневных данных за лето 2019 года,
# постройте регрессионную зависимость скорости сокотечения (переменная Flux) 
# для деревьев вида Larix sibirica
